...
#include "FgControlRigLib/Public/FgControlRigLibBPLibrary.h"
#include "LiveLinkInterface/Public/Roles/LiveLinkBasicTypes.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeFgControlRigLibBPLibrary() {}
// Cross Module References
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FVector2D();
	ENGINE_API UClass* Z_Construct_UClass_UBlueprintFunctionLibrary();
	FGCONTROLRIGLIB_API UClass* Z_Construct_UClass_UFgControlRigLibBPLibrary();
	FGCONTROLRIGLIB_API UClass* Z_Construct_UClass_UFgControlRigLibBPLibrary_NoRegister();
	FGCONTROLRIGLIB_API UScriptStruct* Z_Construct_UScriptStruct_FFgContrlRigStruct();
	LIVELINKINTERFACE_API UScriptStruct* Z_Construct_UScriptStruct_FLiveLinkBasicBlueprintData();
	UPackage* Z_Construct_UPackage__Script_FgControlRigLib();
...
class UScriptStruct* FFgContrlRigStruct::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FgContrlRigStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FFgContrlRigStruct, Z_Construct_UPackage__Script_FgControlRigLib(), TEXT("FgContrlRigStruct"));
	}
	return Z_Registration_Info_UScriptStruct_FgContrlRigStruct.OuterSingleton;
}
template<> FGCONTROLRIGLIB_API UScriptStruct* StaticStruct<FFgContrlRigStruct>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FFgContrlRigStruct_Statics::Struct_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Public/FgControlRigLibBPLibrary.h" },
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FFgContrlRigStruct_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_FgControlRigLib,
		nullptr,
		&NewStructOps,
		"FgContrlRigStruct",
	...
	DEFINE_FUNCTION(UFgControlRigLibBPLibrary::execFgGetControlRigData)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(FFgContrlRigStruct*)Z_Param__Result=UFgControlRigLibBPLibrary::FgGetControlRigData();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UFgControlRigLibBPLibrary::execFgParsingLiveLinkData)
	{
		P_GET_STRUCT_REF(FLiveLinkBasicBlueprintData,Z_Param_Out_data);
		P_FINISH;
		P_NATIVE_BEGIN;
		UFgControlRigLibBPLibrary::FgParsingLiveLinkData(Z_Param_Out_data);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UFgControlRigLibBPLibrary::execFgSetPropertyNames)
	{
		P_GET_STRUCT_REF(FLiveLinkBasicBlueprintData,Z_Param_Out_data);
		P_FINISH;
		P_NATIVE_BEGIN;
		UFgControlRigLibBPLibrary::FgSetPropertyNames(Z_Param_Out_data);
		P_NATIVE_END;
	}
	void UFgControlRigLibBPLibrary::StaticRegisterNativesUFgControlRigLibBPLibrary()
	{
		UClass* Class = UFgControlRigLibBPLibrary::StaticClass();
		static const FNameNativePtrPair Funcs[] = {
			{ "FgGetControlRigData", &UFgControlRigLibBPLibrary::execFgGetControlRigData },
			{ "FgParsingLiveLinkData", &UFgControlRigLibBPLibrary::execFgParsingLiveLinkData },
			{ "FgSetPropertyNames", &UFgControlRigLibBPLibrary::execFgSetPropertyNames },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgGetControlRigData_Statics
	{
		struct FgControlRigLibBPLibrary_eventFgGetControlRigData_Parms
		{
			FFgContrlRigStruct ReturnValue;
		};
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgGetControlRigData_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FgControlRigLibBPLibrary_eventFgGetControlRigData_Parms, ReturnValue), Z_Construct_UScriptStruct_FFgContrlRigStruct, METADATA_PARAMS(nullptr, 0) }; // 1455386830
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgGetControlRigData_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgGetControlRigData_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgGetControlRigData_Statics::Function_MetaDataParams[] = {
		{ "Category", "FaceGood" },
		{ "DisplayName", "ParsingLiveLinkData" },
		{ "Keywords", "FgControlRigLib" },
		{ "ModuleRelativePath", "Public/FgControlRigLibBPLibrary.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgGetControlRigData_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFgControlRigLibBPLibrary, nullptr, "FgGetControlRigData", nullptr, nullptr, sizeof(Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgGetControlRigData_Statics::FgControlRigLibBPLibrary_eventFgGetControlRigData_Parms), Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgGetControlRigData_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgGetControlRigData_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgGetControlRigData_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgGetControlRigData_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgGetControlRigData()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgGetControlRigData_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgParsingLiveLinkData_Statics
	{
		struct FgControlRigLibBPLibrary_eventFgParsingLiveLinkData_Parms
		{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgParsingLiveLinkData_Statics::NewProp_data_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgParsingLiveLinkData_Statics::NewProp_data = { "data", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FgControlRigLibBPLibrary_eventFgParsingLiveLinkData_Parms, data), Z_Construct_UScriptStruct_FLiveLinkBasicBlueprintData, METADATA_PARAMS(Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgParsingLiveLinkData_Statics::NewProp_data_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgParsingLiveLinkData_Statics::NewProp_data_MetaData)) }; // 917839139
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgParsingLiveLinkData_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgParsingLiveLinkData_Statics::NewProp_data,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgParsingLiveLinkData_Statics::Function_MetaDataParams[] = {
		{ "Category", "FaceGood" },
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgParsingLiveLinkData_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFgControlRigLibBPLibrary, nullptr, "FgParsingLiveLinkData", nullptr, nullptr, sizeof(Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgParsingLiveLinkData_Statics::FgControlRigLibBPLibrary_eventFgParsingLiveLinkData_Parms), Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgParsingLiveLinkData_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgParsingLiveLinkData_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgParsingLiveLinkData_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgParsingLiveLinkData_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgParsingLiveLinkData()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgParsingLiveLinkData_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgSetPropertyNames_Statics
	{
		struct FgControlRigLibBPLibrary_eventFgSetPropertyNames_Parms
		{
			FLiveLinkBasicBlueprintData data;
		};
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgSetPropertyNames_Statics::NewProp_data_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgSetPropertyNames_Statics::NewProp_data = { "data", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FgControlRigLibBPLibrary_eventFgSetPropertyNames_Parms, data), Z_Construct_UScriptStruct_FLiveLinkBasicBlueprintData, METADATA_PARAMS(Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgSetPropertyNames_Statics::NewProp_data_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgSetPropertyNames_Statics::NewProp_data_MetaData)) }; // 917839139
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgSetPropertyNames_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgSetPropertyNames_Statics::NewProp_data,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgSetPropertyNames_Statics::Function_MetaDataParams[] = {
		{ "Category", "FaceGood" },
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgSetPropertyNames_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFgControlRigLibBPLibrary, nullptr, "FgSetPropertyNames", nullptr, nullptr, sizeof(Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgSetPropertyNames_Statics::FgControlRigLibBPLibrary_eventFgSetPropertyNames_Parms), Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgSetPropertyNames_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgSetPropertyNames_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgSetPropertyNames_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgSetPropertyNames_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgSetPropertyNames()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgSetPropertyNames_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UFgControlRigLibBPLibrary);
	UClass* Z_Construct_UClass_UFgControlRigLibBPLibrary_NoRegister()
	{
		return UFgControlRigLibBPLibrary::StaticClass();
	}
	struct Z_Construct_UClass_UFgControlRigLibBPLibrary_Statics
	{
	...
	UObject* (*const Z_Construct_UClass_UFgControlRigLibBPLibrary_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_UBlueprintFunctionLibrary,
		(UObject* (*)())Z_Construct_UPackage__Script_FgControlRigLib,
	};
	const FClassFunctionLinkInfo Z_Construct_UClass_UFgControlRigLibBPLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgGetControlRigData, "FgGetControlRigData" }, // 1326326936
		{ &Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgParsingLiveLinkData, "FgParsingLiveLinkData" }, // 2045905513
		{ &Z_Construct_UFunction_UFgControlRigLibBPLibrary_FgSetPropertyNames, "FgSetPropertyNames" }, // 235587021
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UFgControlRigLibBPLibrary_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "FgControlRigLibBPLibrary.h" },
		{ "ModuleRelativePath", "Public/FgControlRigLibBPLibrary.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UFgControlRigLibBPLibrary_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<UFgControlRigLibBPLibrary>::IsAbstract,
	};
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UFgControlRigLibBPLibrary_Statics::ClassParams = {
		&UFgControlRigLibBPLibrary::StaticClass,
		nullptr,
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UFgControlRigLibBPLibrary_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UFgControlRigLibBPLibrary_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_UFgControlRigLibBPLibrary()
	{
		if (!Z_Registration_Info_UClass_UFgControlRigLibBPLibrary.OuterSingleton)
		{
			UECodeGen_Private::ConstructUClass(Z_Registration_Info_UClass_UFgControlRigLibBPLibrary.OuterSingleton, Z_Construct_UClass_UFgControlRigLibBPLibrary_Statics::ClassParams);
		}
		return Z_Registration_Info_UClass_UFgControlRigLibBPLibrary.OuterSingleton;
	}
	template<> FGCONTROLRIGLIB_API UClass* StaticClass<UFgControlRigLibBPLibrary>()
	{
		return UFgControlRigLibBPLibrary::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UFgControlRigLibBPLibrary);
	UFgControlRigLibBPLibrary::~UFgControlRigLibBPLibrary() {}
	struct Z_CompiledInDeferFile_FID_FgControlRigPlugin_Plugins_FgControlRigLib_Source_FgControlRigLib_Public_FgControlRigLibBPLibrary_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FgControlRigPlugin_Plugins_FgControlRigLib_Source_FgControlRigLib_Public_FgControlRigLibBPLibrary_h_Statics::ScriptStructInfo[] = {
		{ FFgContrlRigStruct::StaticStruct, Z_Construct_UScriptStruct_FFgContrlRigStruct_Statics::NewStructOps, TEXT("FgContrlRigStruct"), &Z_Registration_Info_UScriptStruct_FgContrlRigStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFgContrlRigStruct), 1455386830U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FgControlRigPlugin_Plugins_FgControlRigLib_Source_FgControlRigLib_Public_FgControlRigLibBPLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFgControlRigLibBPLibrary, UFgControlRigLibBPLibrary::StaticClass, TEXT("UFgControlRigLibBPLibrary"), &Z_Registration_Info_UClass_UFgControlRigLibBPLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFgControlRigLibBPLibrary), 1546192432U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FgControlRigPlugin_Plugins_FgControlRigLib_Source_FgControlRigLib_Public_FgControlRigLibBPLibrary_h_3086349284(TEXT("/Script/FgControlRigLib"),
		Z_CompiledInDeferFile_FID_FgControlRigPlugin_Plugins_FgControlRigLib_Source_FgControlRigLib_Public_FgControlRigLibBPLibrary_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_FgControlRigPlugin_Plugins_FgControlRigLib_Source_FgControlRigLib_Public_FgControlRigLibBPLibrary_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_FgControlRigPlugin_Plugins_FgControlRigLib_Source_FgControlRigLib_Public_FgControlRigLibBPLibrary_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_FgControlRigPlugin_Plugins_FgControlRigLib_Source_FgControlRigLib_Public_FgControlRigLibBPLibrary_h_Statics::ScriptStructInfo),
		nullptr, 0);
